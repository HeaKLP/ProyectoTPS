...
public class interfazPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnCategorias.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/transaccion.png"))); // NOI18N
        ...
        btnManual.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/transaccion.png"))); // NOI18N
        btnManual.setText("MANUAL");
        btnManual.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 10, 1, 1, new javax.swing.ImageIcon(getClass().getResource("/Imagenes/inicio.png")))); // NOI18N
        ...
        opcionesLayout.setVerticalGroup(
            ...
            .addGroup(opcionesLayout.createSequentialGroup()
                ...
                .addGap(0, 0, 0)
                .addComponent(btnManual, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnCategoriasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCategoriasActionPerformed
        interfazCategoria categoria = new interfazCategoria();
        categoria.setSize(860,500);
    ...
    private void btnManualActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManualActionPerformed
        ...
        File archivo = new File("src/Archivos/manual.pdf"); 
    ...
    private void propiedadesBotones(){
       ...
       //Boton Laboratorio
        ...
        @Override
        public void mouseEntered(java.awt.event.MouseEvent evt) {
            btnManual.setBackground(new java.awt.Color(50, 150, 255)); // Color al pasar el mouse
            btnManual.setOpaque(true); // Asegura que se vea el cambio de color
        }

        @Override
        public void mouseExited(java.awt.event.MouseEvent evt) {
            btnManual.setBackground(new java.awt.Color(25, 80, 180)); // Color original
        }
    });
